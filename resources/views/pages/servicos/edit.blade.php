...
@section('content')
    <div class="card shadow mb-4 mx-0 ">
        ...
        <div class="card-body">
            ...
            <form method="post" action="{{ route('servico.update', ['empresa' => $empresa->id, 'servico' => $servico->id]) }}">
                @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user"
                        ...
                        value="{{ $servico->orcamento_previo }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control form-control-user"
                        ...
                        value="{" 
                        cols="30" rows="10"
                        required>{{ $servico->descricao }}</textarea>
                </div>
